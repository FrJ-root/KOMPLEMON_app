...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Créer un Nouveau Coupon</h2>
        </div>
            ...
            <div class="card-body">
                <div class="form-preview">
                    <div class="coupon-preview">
                        <div class="coupon-preview-header">
                            ...
                            <div class="coupon-preview-status active">Actif</div>
                        </div>
                        <div class="coupon-preview-body">
                            <div class="coupon-preview-code" id="previewCode">CODE10</div>
                            <div class="coupon-preview-discount" id="previewDiscount">10% de réduction</div>
                            <div class="coupon-preview-description" id="previewDescription">Description du coupon</div>
                            <div class="coupon-preview-expiry" id="previewExpiry">Expire le: 31/12/2023</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        @enderror
                        <small class="form-text text-muted">Le code que les clients saisiront pour appliquer la réduction.</small>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label">Type de réduction <span class="required">*</span></label>
                        <div class="discount-type-toggle">
                            <input type="radio" class="btn-check" name="discount_type" id="percent_type" autocomplete="off" checked>
                    ...
                    <div class="form-group" id="amount_discount_group" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">Description optionnelle du coupon.</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Décochez pour créer un coupon inactif.</small>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function updatePreview() {
        ...
        previewCode.textContent = codeInput.value || 'CODE10';
        
        // Update discount
        const previewDiscount = document.getElementById('previewDiscount');
        const percentInput = document.getElementById('discount_percent');
        const amountInput = document.getElementById('amount_discount_group').style.display !== 'none' ? 
                          document.getElementById('discount_amount') : null;
        ...
        if (amountInput && amountInput.value) {
            ...
            previewDiscount.textContent = '10% de réduction';
        }
        
        // Update description
        const descriptionInput = document.getElementById('description');
        const previewDescription = document.getElementById('previewDescription');
        previewDescription.textContent = descriptionInput.value || 'Description du coupon';

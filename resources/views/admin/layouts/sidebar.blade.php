                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                <a href="{{ route('users.edit', $user) }}" class="text-blue-400 hover:text-blue-300" title="Modifier">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                    </svg>
                                </a>
...
@if(auth()->user()->hasRole('gestionnaire_produits') || auth()->user()->isAdmin())
<div class="mb-2">
    <div class="text-gray-400 text-xs uppercase font-semibold px-4 py-2">Catalogue</div>
...
<div class="mb-2">
    <div class="text-gray-400 text-xs uppercase font-semibold px-4 py-2">Administration</div>
    <ul class="mt-2 space-y-1">
        <li>
...
@if(auth()->user()->hasRole('editeur_contenu') || auth()->user()->isAdmin())
<div class="mb-2">
    <div class="text-gray-400 text-xs uppercase font-semibold px-4 py-2">Contenu</div>
    <ul class="mt-2 space-y-1">
        <li>

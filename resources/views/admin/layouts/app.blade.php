...
<head>
    ...
    <style>
        ...
        /* Apply to tables and overflow containers */
        .overflow-x-auto {
            ...
            <div id="sidebar" class="w-64 bg-black min-h-screen p-6">
                ...
                <nav class="space-y-4">
                    ...
                    @elseif(auth()->user()->role === 'gestionnaire_commandes')
                        ...
                        <a href="{{ route('clients.index') }}" class="flex items-center gap-3 text-gray-400 hover:text-gray-200 {{ request()->is('admin/clients*') ? 'text-gray-200' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif(auth()->user()->role === 'editeur_contenu')
                        <a href="{{ route('articles.index') }}" class="flex items-center gap-3 text-gray-400 hover:text-gray-200 {{ request()->is('admin/articles*') ? 'text-gray-200' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('testimonials.index') }}" class="flex items-center gap-3 text-gray-400 hover:text-gray-200 {{ request()->is('admin/testimonials*') ? 'text-gray-200' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
